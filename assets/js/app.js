...
function openDropdown() {
    ...
    var dropdown = anchor.parents(".menu").parent();
...
function openInventoryOverview() {
    ...
    dropdown.on('click', function(event) {
        ...
        var defaultOpen = parent.find('.default-open');

        if(!defaultOpen){
            return true;
        }

        window.location.href = defaultOpen.attr('href');
        return false;
    });
}
    ...
    button.on('click', function() {
        ...
        */
        ...
        $('#addr' + i).html("<td>" 
            + (i + 1) 
            + "</td><td><input name='name" + i
            + "' type='checkbox' class='form-control day-selected css-input css-checkbox css-checkbox-primary remove-margin-t remove-margin-b' checked='' />    "
        ...
        init: function($func) {
            switch ($func) {
                ...
                default:
                    ...
                    // On click on Inventory, redirect to /hardOverview only
                    // if Inventory dropdown is not open, otherwise, just
                    // close it.
                    openInventoryOverview();
            }
        },
